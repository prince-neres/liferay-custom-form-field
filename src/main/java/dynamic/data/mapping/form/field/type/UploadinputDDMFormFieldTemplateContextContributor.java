...
@Component(
    property = "ddm.form.field.type.name=upload-input",
    service = DDMFormFieldTemplateContextContributor.class
)
public class UploadinputDDMFormFieldTemplateContextContributor
    ...
    protected String getFileEntryURL(
        ...
        com.liferay.petra.string.StringBundler sb = new com.liferay.petra.string.StringBundler(9);
    ...
    private static final Log _log = LogFactoryUtil.getLog(
        UploadinputDDMFormFieldTemplateContextContributor.class);
